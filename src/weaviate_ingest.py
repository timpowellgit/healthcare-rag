"""
Script to connect to Weaviate, create collections, and import data from JSON files.
...
It can be configured via environment variables and command-line arguments.
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Weaviate Data Loader Script")
    parser.add_argument(
        "--collection",
        action="append",
        nargs=2,
